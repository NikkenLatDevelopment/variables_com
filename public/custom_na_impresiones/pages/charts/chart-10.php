	...
	<div style="width: 100%; height: 1300px; position: relative;">
		...
		<?php
			if(trim($codeUser) === '7086800' || trim($codeUser) === '7087000' || trim($codeUser) === '867329900'){
				...
				echo '<iframe src="https://mi.nikkenlatam.com/getRadialGen_usa/' . base64_encode($codeUser) . '/<?php echo $periodoPost ?>" frameborder="0" style="width: 90%; height: 1300px; margin-left: 10%;" id="radialGraph"></iframe>';
			}
		?>
		
		<div style="position: absolute; bottom: 150px; left: 50px; max-width: 450px;">
			<img src="custom_na_impresiones/pages/charts/chart/<?php echo $codeUser ?>-min.png?v=<?php echo date("YmdHis") ?>" class="img-fluid mt-2">
		...
		<img src="custom_na_impresiones/img/logo-black.png?v=<?php echo date("YmdHis") ?>" class="img-fluid mt-4 pt-4 pull-right w-25" style="float: right;opacity: 0.5;margin-top: -200px !important;">
	</div>
</div>