...
$sql = "EXEC [dbo].[grafica_cambio_ideal] @COD_ASESOR = '$code'";
...
while ($row_sap = sqlsrv_fetch_array($recordSet, SQLSRV_FETCH_NUMERIC)) {
	...
	$vtaProducto = trim($row_sap[2]);
	if($vtaProducto == ""){ $vtaProducto = 0; }
	$vtaProducto = trim(str_replace(",", "", number_format($vtaProducto, 0, '.', '')));

	$vtaRepuestos = trim($row_sap[3]);
	if($vtaRepuestos == ""){ $vtaRepuestos = 0; }
	$vtaRepuestos = trim(str_replace(",", "", number_format($vtaRepuestos, 0, '.', '')));

	$vtaIdeal = trim($row_sap[4]);
	if($vtaIdeal == ""){ $vtaIdeal = 0; }
	$vtaIdeal = trim(str_replace(",", "", number_format($vtaIdeal, 0, '.', '')));

	$cumplimiento = trim($row_sap[5]);
		...
		<div class="row d-flex align-items-center">
			<div class="col-4">
				<div class="row">
					...
					<div class="col">2013 - 2021Enero a Diciembre</div>
				</div>

				<div class="row">
					<div class="col"></div>
					<div class="col">2022Enero a Marzo</div>
				</div>
...
<!-- Gráficas -->
	<div class="mb-3">COMPORTAMIENTO DE COMPRA DE PRODUCTO VS COMPRA DE REPUESTOS</div>

	<div class="row d-flex align-items-center mt-5">
		<div class="col-12 text-center">
			<!-- Pimag Waterfall -->
			<canvas id="viewChart8" class="w-100" height="500"></canvas>
			<!-- Pimag Waterfall -->
		</div>
	</div>
	...
	<div class="row mt-5">
		<div class="col-12 text-center">
			<!-- Pimag Pi Water -->
			<canvas id="viewChart88" class="w-100" height="500"></canvas>
			<!-- Pimag Pi Water -->
		</div>
	</div>
<!-- Gráficas -->
	...
	<div class="mb-4 mt-5">
		...
		<div class="row d-flex align-items-center">
			<div class="col-4">
				<div class="row">
					<div class="col"><strong>Periodo de Medición:</strong></div>
					<div class="col">2013 - 2021 Enero a Diciembre</div>
				</div>
...
<!-- Gráficas -->
	...
	<div class="row mt-5">
		<div class="col-12 text-center">
			<!-- Kenko Air Purifier -->
			<canvas id="viewChart888" class="w-100" height="500"></canvas>
			<!-- Kenko Air Purifier -->
		</div>
	</div>
	...
	<div class="row mt-5">
		<div class="col-12 text-center">
			<!-- Pimag Optimizer -->
			<canvas id="viewChart8888" class="w-100" height="500"></canvas>
			<!-- Pimag Optimizer -->
		</div>
	</div>
<!-- Gráficas -->
...
<!-- Gráficas -->
	...
	<div class="row mt-5">
		<div class="col-12 text-center">
			<!-- Ducha Manual -->
			<canvas id="viewChart88888" class="w-100" height="500"></canvas>
			<!-- Ducha Manual -->
		</div>
	</div>
	...
	<div class="row mt-5">
		<div class="col-12 text-center">
			<!-- Ducha Pared -->
			<canvas id="viewChart888888" class="w-100" height="500"></canvas>
			<!-- Ducha Pared -->
		</div>
	</div>
<!-- Gráficas -->
		...
		var viewChart8Detail = new Chart(viewChart8, {
		    ...
		    data: {
		        ...
		        datasets: [
			        ...
			        {
			            label: 'vta_ideal',
			            data: [<?php echo $waterfallVtaIdeal2013 ?>, <?php echo $waterfallVtaIdeal2014 ?>, <?php echo $waterfallVtaIdeal2015 ?>, <?php echo $waterfallVtaIdeal2016 ?>, <?php echo $waterfallVtaIdeal2017 ?>, <?php echo $waterfallVtaIdeal2018 ?>, <?php echo $waterfallVtaIdeal2019 ?>, <?php echo $waterfallVtaIdeal2020 ?>, <?php echo $waterfallVtaIdeal2021 ?>],
		...
		var viewChart88Detail = new Chart(viewChart88, {
		    ...
		    data: {
		        ...
		        datasets: [
			        ...
			        {
			            label: 'vta_producto',
			            data: [<?php echo $piWaterVtaProducto2013 ?>, <?php echo $piWaterVtaProducto2014 ?>, <?php echo $piWaterVtaProducto2015 ?>, <?php echo $piWaterVtaProducto2016 ?>, <?php echo $piWaterVtaProducto2017 ?>, <?php echo $piWaterVtaProducto2018 ?>, <?php echo $piWaterVtaProducto2019 ?>, <?php echo $piWaterVtaProducto2020 ?>, <?php echo $piWaterVtaProducto2021 ?>],
			            backgroundColor: [ 'rgba(235, 125, 60, 1)', ],
			            borderColor: [ 'rgba(235, 125, 60, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
			        ...
			        {
			            label: 'vta_ideal',
			            data: [<?php echo $piWaterVtaIdeal2013 ?>, <?php echo $piWaterVtaIdeal2014 ?>, <?php echo $piWaterVtaIdeal2015 ?>, <?php echo $piWaterVtaIdeal2016 ?>, <?php echo $piWaterVtaIdeal2017 ?>, <?php echo $piWaterVtaIdeal2018 ?>, <?php echo $piWaterVtaIdeal2019 ?>, <?php echo $piWaterVtaIdeal2020 ?>, <?php echo $piWaterVtaIdeal2021 ?>],
			            backgroundColor: [ 'rgba(253, 191, 45, 1)', ],
			            borderColor: [ 'rgba(253, 191, 45, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
		...
		var viewChart888Detail = new Chart(viewChart888, {
		    ...
		    data: {
		        ...
		        datasets: [
			        {
			            label: 'Cumplimiento',
			            data: [<?php echo $kenkoAirCumplimiento2013 ?>, <?php echo $kenkoAirCumplimiento2014 ?>, <?php echo $kenkoAirCumplimiento2015 ?>, <?php echo $kenkoAirCumplimiento2016 ?>, <?php echo $kenkoAirCumplimiento2017 ?>, <?php echo $kenkoAirCumplimiento2018 ?>, <?php echo $kenkoAirCumplimiento2019 ?>, <?php echo $kenkoAirCumplimiento2020 ?>, <?php echo $kenkoAirCumplimiento2021 ?>],
			            backgroundColor: [ 'rgba(27, 62, 115, 1)', ],
			            borderColor: [ 'rgba(27, 62, 115, 1)', ],
			            yAxisID: 'y1',
			            type: 'line',
			        ...
			        {
			            label: 'vta_producto',
			            data: [<?php echo $kenkoAirVtaProducto2013 ?>, <?php echo $kenkoAirVtaProducto2014 ?>, <?php echo $kenkoAirVtaProducto2015 ?>, <?php echo $kenkoAirVtaProducto2016 ?>, <?php echo $kenkoAirVtaProducto2017 ?>, <?php echo $kenkoAirVtaProducto2018 ?>, <?php echo $kenkoAirVtaProducto2019 ?>, <?php echo $kenkoAirVtaProducto2020 ?>, <?php echo $kenkoAirVtaProducto2021 ?>],
			            backgroundColor: [ 'rgba(235, 125, 60, 1)', ],
			            borderColor: [ 'rgba(235, 125, 60, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
		...
		var viewChart8888Detail = new Chart(viewChart8888, {
		    ...
		    data: {
		        ...
		        datasets: [
			        {
			            label: 'Cumplimiento',
			            data: [<?php echo $optimizerCumplimiento2013 ?>, <?php echo $optimizerCumplimiento2014 ?>, <?php echo $optimizerCumplimiento2015 ?>, <?php echo $optimizerCumplimiento2016 ?>, <?php echo $optimizerCumplimiento2017 ?>, <?php echo $optimizerCumplimiento2018 ?>, <?php echo $optimizerCumplimiento2019 ?>, <?php echo $optimizerCumplimiento2020 ?>, <?php echo $optimizerCumplimiento2021 ?>],
			            backgroundColor: [ 'rgba(27, 62, 115, 1)', ],
			            borderColor: [ 'rgba(27, 62, 115, 1)', ],
			            yAxisID: 'y1',
			            type: 'line',
			        ...
			        {
			            label: 'vta_ideal',
			            data: [<?php echo $optimizerVtaIdeal2013 ?>, <?php echo $optimizerVtaIdeal2014 ?>, <?php echo $optimizerVtaIdeal2015 ?>, <?php echo $optimizerVtaIdeal2016 ?>, <?php echo $optimizerVtaIdeal2017 ?>, <?php echo $optimizerVtaIdeal2018 ?>, <?php echo $optimizerVtaIdeal2019 ?>, <?php echo $optimizerVtaIdeal2020 ?>, <?php echo $optimizerVtaIdeal2021 ?>],
			            backgroundColor: [ 'rgba(253, 191, 45, 1)', ],
			            borderColor: [ 'rgba(253, 191, 45, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
		...
		var viewChart88888Detail = new Chart(viewChart88888, {
		    ...
		    data: {
		        ...
		        datasets: [
			        ...
			        {
			            label: 'vta_repuestos',
			            data: [<?php echo $duchaManualVtaRepuestos2013 ?>, <?php echo $duchaManualVtaRepuestos2014 ?>, <?php echo $duchaManualVtaRepuestos2015 ?>, <?php echo $duchaManualVtaRepuestos2016 ?>, <?php echo $duchaManualVtaRepuestos2017 ?>, <?php echo $duchaManualVtaRepuestos2018 ?>, <?php echo $duchaManualVtaRepuestos2019 ?>, <?php echo $duchaManualVtaRepuestos2020 ?>, <?php echo $duchaManualVtaRepuestos2021 ?>],
			            backgroundColor: [ 'rgba(165, 165, 165, 1)', ],
			            borderColor: [ 'rgba(165, 165, 165, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
			        ...
			        {
			            label: 'vta_ideal',
			            data: [<?php echo $duchaManualVtaIdeal2013 ?>, <?php echo $duchaManualVtaIdeal2014 ?>, <?php echo $duchaManualVtaIdeal2015 ?>, <?php echo $duchaManualVtaIdeal2016 ?>, <?php echo $duchaManualVtaIdeal2017 ?>, <?php echo $duchaManualVtaIdeal2018 ?>, <?php echo $duchaManualVtaIdeal2019 ?>, <?php echo $duchaManualVtaIdeal2020 ?>, <?php echo $duchaManualVtaIdeal2021 ?>],
			            backgroundColor: [ 'rgba(253, 191, 45, 1)', ],
			            borderColor: [ 'rgba(253, 191, 45, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
		...
		var viewChart888888Detail = new Chart(viewChart888888, {
		    ...
		    data: {
		        ...
		        datasets: [
			        ...
			        {
			            label: 'vta_ideal',
			            data: [<?php echo $duchaParedVtaIdeal2013 ?>, <?php echo $duchaParedVtaIdeal2014 ?>, <?php echo $duchaParedVtaIdeal2015 ?>, <?php echo $duchaParedVtaIdeal2016 ?>, <?php echo $duchaParedVtaIdeal2017 ?>, <?php echo $duchaParedVtaIdeal2018 ?>, <?php echo $duchaParedVtaIdeal2019 ?>, <?php echo $duchaParedVtaIdeal2020 ?>, <?php echo $duchaParedVtaIdeal2021 ?>],
			            backgroundColor: [ 'rgba(253, 191, 45, 1)', ],
			            borderColor: [ 'rgba(253, 191, 45, 1)', ],
			            yAxisID: 'y',
			            datalabels: {
