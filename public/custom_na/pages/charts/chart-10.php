...
<div style="padding-top: 100px;">
	<div style="width: 100%; height: 1300px; position: relative;">
		...
		<div style="position: absolute; bottom: 150px; left: 50px; max-width: 450px;">
			<img src="custom_na/pages/charts/chart/<?php echo $codeUser ?>-min.png?<?php echo date("YmdHis") ?>" class="img-fluid mt-2">
		...
		<img src="custom_na/img/logo-black.png?<?php echo date("YmdHis") ?>" class="img-fluid mt-4 pt-4 pull-right w-25" style="float: right;opacity: 0.5;margin-top: -200px !important;">
	</div>
</div>