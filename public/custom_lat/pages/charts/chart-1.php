	...
	<table class="table table-bordered align-middle">
		<thead>
			<tr class="text-center">
				...
				<th scope="col" class="c-mw-2">Total 24<br/>Meses</th>
			</tr>
		</thead>
		...
		<tbody>
			<!-- Compras Personales (Dólares) -->
				<tr>
					<th scope="row">Compras Personales (Dólares)</th>
			...
			<!-- Compras de Clientes Preferentes (Dólares) -->
				<tr>
					<th scope="row">Compras de Clientes <br/>Preferentes (Dólares)</th>
			...
			<!-- Compras Organizacional (Dólares) -->
				<tr>
					<th scope="row">Compras Organizacional <br/>(Dólares)</th>
			...
			<!-- Compra Total (Dólares) -->
				<tr>
					<th scope="row">Compra Total (Dólares)</th>
			...
			<!-- Compra Promedio por Activo (Dólares) -->
				<tr>
					<th scope="row">Compra Promedio por Activo<br/>(Dólares)</th>
			...
			<!-- Otras Variables -->
				<tr>
					...
					<td colspan="2"></td>
					<td colspan="4"><strong>Crecimiento Compra Promedio<br/>Por Activo (Dólares) %</strong></td>
					<td colspan="2" class="text-center">
						<strong>
							<?php
					...
					<td colspan="2"></td>
					<td colspan="4"><strong>Compras Personales del Último <br/>Año (Dólares)</strong></td>
					<td colspan="2" class="text-center">
						<strong>
							<?php
				...
				<tr>
					...
					<td colspan="10"></td>
					<td colspan="4"><strong>Compras Totales del Último<br/>Año (Dólares)</strong></td>
					<td colspan="2" class="text-center">
						<strong>
							<?php
...
<div class="fw-bold mb-4" style="color: red;">* Lo que se encuentra con asterisco (*) su cálculo es promedio.</div>
<!-- Notas -->
