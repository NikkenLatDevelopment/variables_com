	...
	<table class="table align-middle table-bordered">
		<thead>
			<tr class="text-center">
				<th scope="col" class="c-mw-1">PUNTOS</th>
				...
				<th scope="col" class="c-mw-2">Promedio 24<br/>Meses</th>
			</tr>
		</thead>
		...
		<tbody>
			<!-- VP (Volumen Personal) -->
				<tr>
					<th scope="row">VP (Volumen Personal)</th>
			...
			<!-- VGP (Volumen Grupo Personal) -->
				<tr>
					<th scope="row">VGP (Volumen Grupo <br/>Personal)</th>
			...
			<!-- VO (Volumen Organizacional) -->
				<tr>
					<th scope="row">VO (Volumen Organizacional)</th>
			...
			<!-- VO-LDP (Volumen Organizacional Línea Diferente a la Primaria) -->
				<tr>
					<th scope="row">VO-LDP (Volumen <br/>Organizacional Línea Diferente <br/>a la Primaria)</th>
			...
			<!-- VO-LDPYS (Volumen Organizacional Línea Diferente a la Primaria y Secundaria) -->
				<tr>
					<th scope="row">VO-LDPYS (Volumen <br/>Organizacional Línea Diferente <br/>a la Primaria y Secundaria)</th>
