...
//Consulta
	...
	$sql = "EXEC Compras_org_anual $codeUser, $periodoPost";
	...
	$sql = "EXEC Incorporaciones_aual_parametrizacion $codeUser, $periodoPost;";
	$recordSet = sqlsrv_query($conn75, $sql) or die( print_r( sqlsrv_errors(), true));
	while($rowSap = sqlsrv_fetch_array($recordSet, SQLSRV_FETCH_NUMERIC)) {
...
(intval($monthToShow[12]) <= intval($periodoPost)) ? array_push($monthLabelGraph, 'Ene') : null;
...
(intval($monthToShow[9]) <= intval($periodoPost)) ? array_push($monthLabelGraph, 'Abr') : null;
...
(intval($monthToShow[5]) <= intval($periodoPost)) ? array_push($monthLabelGraph, 'Ago') : null;
...
(intval($monthToShow[1]) <= intval($periodoPost)) ? array_push($monthLabelGraph, 'Dic') : null;
	...
	<table class="table align-middle table-bordered">
		<thead>
			<tr class="text-center">
				<th scope="col" class="c-mw-1">Compras Organización</th>
		...
		<tbody>
			...
			<!-- Compras Organización 2021 - 2022 -->
				<tr>
					<th scope="row">Crecimiento de la Compra Organización %</th>
...
<div class="table-responsive mt-4">
	<table class="table align-middle table-bordered">
		<thead>
			<tr class="text-center">
				<th scope="col" class="c-mw-1">Incorporación Organización (ABIs + CPs)</th>
		...
		<tbody>
			...
			<!-- Incorporaciones Organización 2021 - 2022 -->
				<tr>
					<th scope="row">Crecimiento de la Incorporación Organización %</th>
...
<div class="table-responsive mt-4">
	<table class="table align-middle table-bordered">
		<thead>
			<tr class="text-center">
				<th scope="col" class="c-mw-1">Activos la Organización</th>
		...
		<tbody>
			...
			<!-- Actividad 2021 - 2022 -->
				<tr>
					<th scope="row">% Activos Mensual</th>
					<?php $months = 0; ?>
					<?php if($classEne == "") { ?><td class="text-center">
						<?php
...
<div class="table-responsive mt-2">
	<table class="table align-middle table-bordered">
		...
		<tbody>
			<!-- No. de Influencers -->
				<tr>
					<th scope="row">Total de Organización (ABIs + CPs)</th>
			...
			<!-- No. de Influencers - Activos Mensuales -->
				<tr>
					<th scope="row">% Actividad de la Organización</th>
			...
			<!-- Optimo (30%) -->
				<tr>
					<th scope="row">Óptimo (30%) de la Organización</th>
			...
			<!-- Activos que Faltaron -->
				<tr>
					<th scope="row">Activos que Faltaron para Llegar al Óptimo</th>
		...
		var chart6Graph2Detail = new Chart(chart6Graph2, {
		    ...
		    options: {
				...
				plugins: {
					title: {
						display: true,
						text: 'Incorporación Organización'
					},
				},
				scales: {
			      	y: {
