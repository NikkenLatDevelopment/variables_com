...
//Consulta
	...
	$sql = "SELECT DISTINCT LTRIM(RTRIM (Country)) from LAT_MyNIKKEN_TEST.dbo.TreePerId_ORG_PER_Comercial_gen ($codeUser,$periodoPost) ORDER BY  ltrim(rtrim(country)) ASC";
    ...
    $sql = "EXEC LAT_MyNIKKEN_TEST.dbo.ConteoComercialD1_16_lat $codeUser, $periodoPost";
...
<div style="padding-top: 100px;">
	<div style="width: 100%; height: 1300px; position: relative;">
		...
		<iframe src="https://testmy.nikkenlatam.com/getRadialGen_usa/<?php echo base64_encode($codeUser) ?>/<?php echo $periodoPost ?>" frameborder="0" style="width: 90%; height: 1300px; margin-left: 10%;" id="radialGraph"></iframe>
		
		<div style="position: absolute; bottom: 150px; left: 50px; max-width: 450px;">
			<img src="custom_na_lat/pages/charts/chart/<?php echo $codeUser ?>-min.png?<?php echo date("YmdHis") ?>" class="img-fluid mt-2">
			...
			<!-- <div class="h6 mt-3 c-c-1"><span class="fw-bold">Measurement Period:</span> <?php echo $monthsYear[$monthToShow[1]] ?> a <?php echo $monthsYear[$periodoPost] ?>.</div> -->
			<div class="h6 mt-3 c-c-1"><span class="fw-bold">Closing period: </span><?php echo $monthsYear[$periodoPost] ?>.</div>
		</div>
		<img src="custom_na_lat/img/logo-black.png?<?php echo date("YmdHis") ?>" class="img-fluid mt-4 pt-4 pull-right w-25" style="float: right;opacity: 0.5;margin-top: -200px !important;">
	</div>
</div>