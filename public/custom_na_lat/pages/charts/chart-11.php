...
//Consulta
	$sql = "EXEC LAT_MyNIKKEN_TEST.dbo.Incorporaciones_anual $codeUser, $periodopost;";
	...
	$sql = "EXEC LAT_MyNIKKEN_TEST.dbo.Incorporaciones_activos_anual $codeUser, $periodopost;";
	$recordSet = sqlsrv_query($conn75, $sql) or die( print_r( sqlsrv_errors(), true));
	while($rowSap = sqlsrv_fetch_array($recordSet, SQLSRV_FETCH_NUMERIC)) {
...
<!-- Cabecera -->
	<div class="row mb-3">
		<div class="col-auto">
			...
			<div class="h6 mb-0"><span class="fw-bold">Measurement Period:</span> <?php echo $monthsYear[$monthToShow[60]] ?> a <?php echo $monthsYear[$periodopost] ?></div>
			...
			<!-- 2019 -->
				<tr>
					...
					<td class="text-center">
						...
						$datagraph2[0] = $total/10;

						echo number_format($total/10, 0);
