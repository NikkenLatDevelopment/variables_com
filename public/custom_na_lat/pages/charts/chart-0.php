...
@$boundingBox = imagettfbbox(25, 0, $templateFontRobotoBold, "NIKKEN LATAM");
...
//Simple
// @imagettftext($template, 25, 0, $widthBoxNameFirst, 43, $color, $templateFontLatoBold, $nameUser);
@imagettftext($template, 25, 0, $widthBoxNameFirst, 43, $color, $templateFontLatoBold, "NIKKEN LATAM");
...
// @imagettftext($template, 25, 0, 950, 1250, imagecolorallocate($template, 102, 51, 102), $templateFontRobotoBold, "Business Variables Report By Consultant");
...
?>
<img src="custom_na_lat/pages/charts/chart/<?php echo $codeUser ?>.png?v=<?php echo Date('YmdHis') ?>" class="img-fluid mt-4 pt-4">
