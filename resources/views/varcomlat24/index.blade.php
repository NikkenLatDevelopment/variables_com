...
<html lang="es">
    <head>
        ...
        <title>Informe Variables Comerciales por Influencer</title>

        <!-- Favicon -->
        <link rel="icon" href="{{ asset('custom/img/favicon/favicon.ico') }}" type="image/x-icon">
        <link rel="shortcut icon" href="{{ asset('custom/img/favicon/favicon.ico') }}" type="image/x-icon">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('custom/img/favicon/apple-touch-icon.png') }}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('custom/img/favicon/favicon-32x32.png') }}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('custom/img/favicon/favicon-16x16.png') }}">
        <link rel="manifest" href="{{ asset('custom/img/favicon/site.webmanifest') }}">
    ...
    <body>
        ...
        <script src="{{ asset('custom_lat/js/main.js?v=' . Date('YmdHis')) }}"></script>
        <!-- Librerías adicionales -->
        ...
        <script>comprasprod1($("#codeUser").val(), $("#nameUser").val(), $("#countrieUser").val(), $("#rankUser").val(), $("#prod").val());</script>
        <script>comprasprod2($("#codeUser").val(), $("#nameUser").val(), $("#countrieUser").val(), $("#rankUser").val(), $("#prod").val());</script>
        <script>comprasprod3($("#codeUser").val(), $("#nameUser").val(), $("#countrieUser").val(), $("#rankUser").val(), $("#prod").val());</script>
    </body>
</html>